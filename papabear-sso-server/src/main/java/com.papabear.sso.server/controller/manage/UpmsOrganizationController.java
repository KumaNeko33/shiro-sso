...
public class UpmsOrganizationController extends BaseController {
    ...
    public Object list(
        ...
        TblOrganizationExample upmsOrganizationExample = new TblOrganizationExample();
        ...
        List<TblOrganization> rows = upmsOrganizationService.selectByExampleForOffsetPage(upmsOrganizationExample, offset, limit);
    ...
    public Object create(TblOrganization upmsOrganization) {
...
//        upmsOrganization.setCreateDateTime(time);
        upmsOrganization.setCreateDateTime(new Date(time));
    ...
    public String update(@PathVariable("id") int id, ModelMap modelMap) {
        TblOrganization organization = upmsOrganizationService.selectByPrimaryKey(id);
    ...
    @ResponseBody
    public Object update(@PathVariable("id") int id, TblOrganization upmsOrganization) {
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsOrganization.getName(), new LengthValidator(1, 20, "名称"))
                .doValidate()
                .result(ResultCollectors.toComplex());
