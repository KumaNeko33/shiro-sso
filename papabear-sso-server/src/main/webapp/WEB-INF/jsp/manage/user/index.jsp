...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'avatarImg', title: '头像', align: 'center', formatter: 'avatarFormatter'},
			{field: 'phone', title: '电话'},
			{field: 'email', title: '邮箱'},
//			{field: 'sex', title: '性别', formatter: 'sexFormatter'},
			{field: 'points', title: '积分'},
			{field: 'expNum', title: '经验值'},
			{field: 'gradeId', title: '等级'},
...
function updateAction() {
	...
	if (rows.length != 1) {
		...
		updateDialog = $.dialog({
			animationSpeed: 300,
			title: '编辑用户',
			content: 'url:${basePath}/manage/user/update/' + rows[0].id,
			onContentReady: function () {
				initMaterialInput();
                initUploader();
			}
