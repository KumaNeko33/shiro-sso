...
<div id="createDialog" class="crudDialog">
	<form id="createForm" method="post">
		...
		<div class="form-group">
			...
			<input id="userPwd" type="text" class="form-control" name="userPwd" maxlength="32">
		</div>
		<div class="form-group">
		...
		<div class="row">
			<div class="col-lg-8 form-group">
				...
				<input id="avatarImg" type="text" class="form-control" name="avatarImg" maxlength="150">
			</div>
			<div class="col-lg-4">
		...
		<div class="radio">
			...
			<div class="radio radio-inline">
				<input id="locked_1" type="radio" name="status" value="-2">
				<label for="locked_1">锁定 </label>
			</div>
			<div class="radio radio-inline radio-success">
				<input id="locked_2" type="radio" name="status" value="0">
				<label for="locked_2">未激活 </label>
			</div>
			<div class="radio radio-inline radio-success">
				<input id="locked_3" type="radio" name="status" value="-1">
...
function initUploader() {
	...
	uploader.on( 'uploadSuccess', function(file, response) {
		$('#avatarImg').val(response.data.filename).focus();
	});
