...
<head>
	...
	<link href="${basePath}/resources/papabear-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/papabear-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/papabear-admin/images/logo.png"/>
			</a>
	...
	<aside id="sidebar">
		...
		<div class="s-profile">
			<a class="waves-effect waves-light" href="javascript:;">
				<div class="sp-pic">
					<img src="${basePath}${upmsUser.avatarImg}"/>
				</div>
				<div class="sp-info">
					${upmsUser.nickName}，您好！
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; PAPABEAR SSO V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>演示地址</b>：<a href="http://www.papabear.cn/papabearAdmin" target="_blank">http://www.papabear.cn/papabearAdmin</a></p>
...
<script src="${basePath}/resources/papabear-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/papabear-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/papabear-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/papabear-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/papabear-admin/js/admin.js"></script>
<script src="${basePath}/resources/papabear-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/papabear-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>