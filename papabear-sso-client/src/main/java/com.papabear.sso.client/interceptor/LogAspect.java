package com.papabear.sso.client.interceptor;

import com.alibaba.fastjson.JSON;
import com.papabear.commons.util.RequestUtil;
...
public class LogAspect {
	...
	public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
		...
		upmsApiService.insertLogSelective(upmsLog);
		return result;
	}
